...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  let secondString = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + secondMult + '.'

  return [secondSum, secondMult, firstString, secondString];
...
// let string = sumArr[0] + ',' + sumArr[1] + ',' +  sumArr[2] + ' was passed in as an array of numbers, and ' + totalTwo + ' is their sum.'
// console.log(string);

let string = sumArr + ' was passed in as an array of numbers, and ' + totalTwo + ' is their sum.'
// console.log(string);

return [totalTwo, string];
